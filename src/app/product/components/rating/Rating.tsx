...
type RatingProps<T extends FieldValues> = { name: Path<T>; setValue: UseFormSetValue<T> };
const STAR_LIST = new Array(5).fill(0).map((_, index) => ({ id: index }));

export default function Rating<T extends FieldValues>({ name, setValue }: RatingProps<T>) {
